...
struct FilesTests {
    ...
    func `When searching for swift files, should find all swift files`() async throws {
        ...
        let input = Files.AnalysisInput(repoPath: samplesURL.path, extension: "swift")
    ...
    func `When searching for storyboard files, should find all storyboards`() async throws {
        let samplesURL = try samplesDirectory()
        let input = Files.AnalysisInput(repoPath: samplesURL.path, extension: "storyboard")
    ...
    func `When searching for xib files, should find all xibs`() async throws {
        let samplesURL = try samplesDirectory()
        let input = Files.AnalysisInput(repoPath: samplesURL.path, extension: "xib")
    ...
    func `When searching for json files, should find all json files`() async throws {
        let samplesURL = try samplesDirectory()
        let input = Files.AnalysisInput(repoPath: samplesURL.path, extension: "json")
    ...
    func `When searching for non-existent extension, should return empty result`() async throws {
        let samplesURL = try samplesDirectory()
        let input = Files.AnalysisInput(repoPath: samplesURL.path, extension: "xyz")
    ...
    func `When searching for multiple filetypes, should return results for each`() async throws {
        ...
        let swiftInput = Files.AnalysisInput(repoPath: samplesURL.path, extension: "swift")
        let storyboardInput = Files.AnalysisInput(
